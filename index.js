...
// AntiMistype
aNiM = ['NiM', -2, -1, 0, 1], aNeM = ['NeM', -2, -1, 0, 1], aSiM = ['SiM', -2, -1, 0, 1], aSeM = ['SeM', -2, -1, 0, 1]
aFiM = ['FiM', -2, -1, 0, 1], aFeM = ['FeM', -2, -1, 0, 1], aTiM = ['TiM', -2, -1, 0, 1], aTeM = ['TeM', -2, -1, 0, 1]
// usage
aNiU = ['NiU', 2, 1, 0, -1], aNeU = ['NeU', 2, 1, 0, -1], aSiU = ['SiU', 2, 1, 0, -1], aSeU = ['SeU', 2, 1, 0, -1]
aFiU = ['FiU', 2, 1, 0, -1], aFeU = ['FeU', 2, 1, 0, -1], aTiU = ['TiU', 2, 1, 0, -1], aTeU = ['TeU', 2, 1, 0, -1]
// trixter
aNiT = ['NiT', 2, 1, 0, -1], aNeT = ['NeT', 2, 1, 0, -1], aSiT = ['SiT', 2, 1, 0, -1], aSeT = ['SeT', 2, 1, 0, -1]
aFiT = ['FiT', 2, 1, 0, -1], aFeT = ['FeT', 2, 1, 0, -1], aTiT = ['TiT', 2, 1, 0, -1], aTeT = ['TeT', 2, 1, 0, -1]
// loops
...
// grips
agNiFe = ['gNiFe', 2, 1, 0, -1], agNiTe = ['gNiTe', 2, 1, 0, -1], agNeFi = ['gNeFi', 2, 1, 0, -1], agNeTi = ['gNeTi', 2, 1, 0, -1]
agSiFe = ['gSiFe', 2, 1, 0, -1], agSiTe = ['gSiTe', 2, 1, 0, -1], agSeFi = ['gSeFi', 2, 1, 0, -1], agSeTi = ['gSeTi', 2, 1, 0, -1]
agFiNe = ['gFiNe', 2, 1, 0, -1], agFiSe = ['gFiSe', 2, 1, 0, -1], agFeNi = ['gFeNi', 2, 1, 0, -1], agFeSi = ['gFeSi', 2, 1, 0, -1]
agTiNe = ['gTiNe', 2, 1, 0, -1], agTiSe = ['gTiSe', 2, 1, 0, -1], agTeNi = ['gTeNi', 2, 1, 0, -1], agTeSi = ['gTeSi', 2, 1, 0, -1]
vgSe = [agNiFe, agNiTe], vgSi = [agNeFi, agNeTi], vgNe = [agSiFe, agSiTe], vgNi = [agSeFi, agSeTi]
vgTe = [agFiNe, agFiSe], vgTi = [agFeNi, agFeSi], vgFe = [agTiNe, agTiSe], vgFi = [agTeNi, agTeSi]
...
question_sets = [
	['Сравнение когнитивных функций и осей', 'Ne/Ni, Se/Si, Fe/Fi, Te/Ti, FiTe/FeTi, NiSe/NeSi', 5, 2, [
		...
		['При выражении своего мнения или позиции чаще использую ассоциации', [aNe, RA(aNi)],
			'При выражении своего мнения или позиции чаще пытаюсь более дословно передать суть через метафоры'],
		...
		['Я больше сопереживаю, чем сочувствую, и делаю это исходя из своего опыта', [aFi, RA(aFe)],
			'Я больше сочувствую, чем сопереживаю, и могу сделать это в любой момент'],
		...
		['В коллективном обсуждении в первую очередь я выясню, какое у кого мнение и как мы можем его скомпоновать', [aFeTi, RA(aFiTe)],
			'В коллективном обсуждении в первую очередь я выясню, кто что хочет и как мы можем добиться нужных результатов'],
		['В стрессе я чувствую что субъективные мнения людей приводят только к разрушению гармонии, поэтому я пытаюсь разрешить конфликты и привить остальным людям нормы морали для избежания подобных ситуаций', [aFeTi, RA(aFiTe)],
			'В стрессе я чувствую что меня задевает излишняя ранимость некоторых людей, что их позиция слишком субъективна и радикальна, и это мешает мне сосредоточиться на объективной оценке ситуации, поэтому я пытаюсь установить систему контроля или продвигать факты для поддержания порядка'],
	...
	['Грипы', 'Грипы - это стрессовое использование только четвертой функции. Грип проявляется при сильном стрессе', 4, 1, [
		['Пытаюсь подавить свои сильные эмоции, стремящиеся вырваться наружу', vgFi],
		['Набрасываюсь на других из-за чувства несправедливости', vgFi],
		['Чувствую, будто меня недооценивают и воспринимают как должное', vgFi],
		['Становлюсь очень дезорганизованным', vgFi],
		['Становится трудно выразить словами свои чувства и эмоции', vgFi],
		['Сильные эмоции, с которыми я не привык справляться, охватывают меня целиком', vgFi],
		['Чувствую, будто каждый против меня, будто все хотят на меня напасть и пытаюсь защищаться', vgFi],
		['Становлюсь зацикленным на своих отношениях и боюсь, что потеряю близких мне людей', vgFe],
		['Чувствую себя оторванным и изолированным от других', vgFe],
		['Эмоционально сверхчувствителен', vgFe],
		['Появляются мысли о том, что никто никогда не сможет меня полюбить', vgFe],
		['Ищу подтверждения и одобрения от других людей. Иногда у меня появляется привычка хвастаться', vgFe],
		['Вступаю в нездоровые, зависимые отношения', vgFe],
		['Становлюсь обидчивым, чувствительным и сентиментальным, что в обычном состоянии для меня непривычно', vgFe],
		['Становлюсь циничным и саркастичным по отношению к другим людям, теряю свою эмпатию', vgTi],
		['Критикую окружающих и делаю им едкие замечания', vgTi],
		['Чувствую себя неловко из-за того, что вышел из-под контроля, дал своей темной стороне выйти наружу', vgTi],
		['Ищу абсолютную истину для решения своих проблем', vgTi],
		['Ставлю барьер между собой и близкими', vgTi],
		['Становлюсь очень самокритичным и разочарованным в самом себе', vgTi],
		['Создаю себе образ другого человека и подавляю свои эмоции ради поддержания этого образа', vgTi],
		['Раздражает нытьё других людей', vgTe],
		['Цель оправдывает средства', vgTe],
		['Если вижу успех другого человека, хочу всем доказать, что я – гораздо лучше, чем он', vgTe],
		['Часами напролёт усердно работаю для достижения цели, напрочь забывая об отдыхе', vgTe],
		['Многие люди кажутся беспомощными', vgTe],
		['Одержимость быть лучше всех', vgTe],
		['Точно знаю, чего хочу, и уверен в том, что это получу', vgTe],
		['Начинается поток ужасных неконтролируемых мыслей', vgNi],
		['Продумываю в голове самые худшие сценарии развития событий', vgNi],
		['Менее терпим и легче раздражаюсь', vgNi],
		['Становлюсь очень подозрительным ко всему', vgNi],
		['Становлюсь рассеянным и забывчивым', vgNi],
		['Постоянное плохое предчувствие', vgNi],
		['Отвлекаюсь на тревожные внутренние образы', vgNi],
		['Теряю способность видеть и замечать детали', vgNe],
		['Становлюсь импульсивным', vgNe],
		['Беспокоюсь обо всех возможных вариантах того, что может пойти не так', vgNe],
		['Придумываю новые непроверенные и непрактичные идеи и возможности в надежде решить проблемы', vgNe],
		['Постоянное ощущение опасности и надвигающейся гибели', vgNe],
		['Чувствую замешательство, панику, тревогу и растерянность', vgNe],
		['Становлюсь менее ответственным, чем обычно', vgNe],
		['Появляется сильное желание изменить прошлое: "Если бы я поступил иначе, этого бы не произошло..."', vgSi],
		['Ощущение, будто я упустил нечто хорошее', vgSi],
		['Неприязнь к "себе из прошлого"', vgSi],
		['Становлюсь параноиком; очень критичен ко всему, иногда дотошный', vgSi],
		['Слишком осведомлён о своем физическом самочувствии, чувствую себя больным; возможно чрезмерно беспокоюсь о своём здоровье', vgSi],
		['Часто преувеличиваю проблемы', vgSi],
		['Стремлюсь к стабильности для того, чтобы почувствовать безопасность, хотя раньше такого за собой не замечал (только в стрессе)', vgSi],
		['Торопливость и импульсивность', vgSe],
		['Паникую и могу впасть в истерику', vgSe],
		['Слишком налегаю на еду', vgSe],
		['Уделяю внимание телу (длительный душ/ванные, уход за собой)', vgSe],
		['Становлюсь агрессивным: могу сильно повысить голос на человека и нагрубить', vgSe],
		['Тянет на причинение себе вреда (порезы, алкоголь)', vgSe],
		['Совершаю необдуманные поступки (например, трачу деньги на ненужные вещи)', vgSe],
	]],
...
function recalc() {
	...
	mbti = [
		[7*Ni + 5*Fe + 3*Ti + 1*Se + 6*NiSe + 6*FeTi + 6*NiP + 4*FeP + 5*lNiFe + 5*gNiFe + 2*TeT, 'INFJ'],
		[7*Ni + 5*Te + 3*Fi + 1*Se + 6*NiSe + 6*FiTe + 6*NiP + 4*TeP + 5*lNiTe + 5*gNiTe + 2*FeT, 'INTJ'],
		[7*Fi + 5*Ne + 3*Si + 1*Te + 6*FiTe + 6*NeSi + 6*FiP + 4*NeP + 5*lFiNe + 5*gFiNe + 2*SeT, 'INFP'],
		[7*Ti + 5*Ne + 3*Si + 1*Fe + 6*FeTi + 6*NeSi + 6*TiP + 4*NeP + 5*lTiNe + 5*gTiNe + 2*SeT, 'INTP'],
		[7*Si + 5*Fe + 3*Ti + 1*Ne + 6*NeSi + 6*FeTi + 6*SiP + 4*FeP + 5*lSiFe + 5*gSiFe + 2*TeT, 'ISFJ'],
		[7*Si + 5*Te + 3*Fi + 1*Ne + 6*NeSi + 6*FiTe + 6*SiP + 4*TeP + 5*lSiTe + 5*gSiTe + 2*FeT, 'ISTJ'],
		[7*Fi + 5*Se + 3*Ni + 1*Te + 6*FiTe + 6*NiSe + 6*FiP + 4*SeP + 5*lFiSe + 5*gFiSe + 2*NeT, 'ISFP'],
		[7*Ti + 5*Se + 3*Ni + 1*Fe + 6*FeTi + 6*NiSe + 6*TiP + 4*SeP + 5*lTiSe + 5*gTiSe + 2*NeT, 'ISTP'],
		[7*Fe + 5*Ni + 3*Se + 1*Ti + 6*FeTi + 6*NiSe + 6*FeP + 4*NiP + 5*lFeNi + 5*gFeNi + 2*SiT, 'ENFJ'],
		[7*Te + 5*Ni + 3*Se + 1*Fi + 6*FiTe + 6*NiSe + 6*TeP + 4*NiP + 5*lTeNi + 5*gTeNi + 2*SiT, 'ENTJ'],
		[7*Ne + 5*Fi + 3*Te + 1*Si + 6*NeSi + 6*FiTe + 6*NeP + 4*FiP + 5*lNeFi + 5*gNeFi + 2*TiT, 'ENFP'],
		[7*Ne + 5*Ti + 3*Fe + 1*Si + 6*NeSi + 6*FeTi + 6*NeP + 4*TiP + 5*lNeTi + 5*gNeTi + 2*FiT, 'ENTP'],
		[7*Fe + 5*Si + 3*Ne + 1*Ti + 6*FeTi + 6*NeSi + 6*FeP + 4*SiP + 5*lFeSi + 5*gFeSi + 2*SeT, 'ESFJ'],
		[7*Te + 5*Si + 3*Ne + 1*Fi + 6*FiTe + 6*NeSi + 6*TeP + 4*SiP + 5*lTeSi + 5*gTeSi + 2*SeT, 'ESTJ'],
		[7*Se + 5*Fi + 3*Te + 1*Ni + 6*NiSe + 6*FiTe + 6*SeP + 4*FiP + 5*lSeFi + 5*gSeFi + 2*TiT, 'ESFP'],
		[7*Se + 5*Ti + 3*Fe + 1*Ni + 6*NiSe + 6*FeTi + 6*SeP + 4*TiP + 5*lSeTi + 5*gSeTi + 2*FiT, 'ESTP'],
	]
